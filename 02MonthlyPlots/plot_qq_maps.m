...
for iQuarter=1:1:4;
  ...
  Cid = squeeze(Data.Results.Cid(iQuarter,:,:,Settings.Layer));
  N   = squeeze(Data.Results.N(  iQuarter,:,:,Settings.Layer));
  ...
  %and store
  Mpkm(iQuarter,:,:) = ThisMonth;
end
clear yi A iQuarter Cid N ThisMonth ThisCid Cluster Area Ntm
