...
Settings.OutFile = 'newcode_clusters_3layer.mat';
...
%number of clusters
Settings.NClusters   = 1000; %the actual number will be slightly less, as some will be dropped and some merged depending on how well they fit the data
